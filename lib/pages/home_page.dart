...
import 'package:Amplify/pages/settins_page.dart';
import 'package:Amplify/widgets/home_popup_menu.dart';
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: ListTile(
                            onTap: () {
                              _player.openPlayer(index, _controller.songModels);
                            },
                            ...
                            trailing: HomePopup(
                              audioId: _controller.songModels[index].metas.id!,
                            ),
                          ),
                        );
                      },
